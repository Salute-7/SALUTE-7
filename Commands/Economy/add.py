...
class add(commands.Cog):
    def __init__(self, bot):  
        self.bot = bot
        print('Файл Commands/Economy/add.py Загружен!')

    @bot.slash_command(name='add', description='Добавить сумму к балансу (🎓)')
    async def add(self, ctx, user: disnake.Member = None, amount: int = None):
